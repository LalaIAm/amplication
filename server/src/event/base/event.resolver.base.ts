...
export class EventResolverBase {
  ...
  async createEvent(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        householdCalendar: args.data.householdCalendar
          ? {
              connect: args.data.householdCalendar,
            }
          : undefined,
  ...
  async attending(
    ...
    const results = await this.service.findAttending(parent.id, args);
  ...
  @graphql.ResolveField(() => HouseholdCalendar, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Event",
    action: "read",
    possession: "any",
  ...
  async householdCalendar(
    ...
    const result = await this.service.getHouseholdCalendar(parent.id);
